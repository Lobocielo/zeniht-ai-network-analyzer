...
class ZenihtAI {
    ...
    buildModel() {
        ...
        this.model.add(tf.layers.dense({ units: 512, inputShape: [dim], activation: 'selu', kernelInitializer: 'heNormal' }));
        this.model.add(tf.layers.batchNormalization());
        this.model.add(tf.layers.dropout({ rate: 0.25 }));
        this.model.add(tf.layers.dense({ units: 384, activation: 'selu', kernelInitializer: 'heNormal' }));
        this.model.add(tf.layers.batchNormalization());
        this.model.add(tf.layers.dropout({ rate: 0.2 }));
        this.model.add(tf.layers.dense({ units: 256, activation: 'selu', kernelInitializer: 'heNormal' }));
        this.model.add(tf.layers.batchNormalization());
        ...
        this.model.add(tf.layers.dense({ units: 64, activation: 'selu' }));
        this.model.add(tf.layers.dense({ units: 128, activation: 'selu', kernelInitializer: 'heNormal' }));
        this.model.add(tf.layers.batchNormalization());
        this.model.add(tf.layers.dense({ units: 256, activation: 'selu', kernelInitializer: 'heNormal' }));
        this.model.add(tf.layers.batchNormalization());
        this.model.add(tf.layers.dropout({ rate: 0.2 }));
        this.model.add(tf.layers.dense({ units: 384, activation: 'selu' }));
        this.model.add(tf.layers.dense({ units: 512, activation: 'selu', kernelInitializer: 'heNormal' }));
        this.model.add(tf.layers.batchNormalization());
        this.model.add(tf.layers.dropout({ rate: 0.25 }));
